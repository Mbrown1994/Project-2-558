...
|:----------|-----:|--------:|--------:|
| Sunday    | 3919 |   33100 |     613 |
| Monday    | 3660 |  139600 |     109 |
| Tuesday   | 4632 |  208300 |     241 |
| Wednesday | 3321 |   73100 |      78 |
| Thursday  | 3771 |   56000 |     173 |
| Friday    | 2958 |   40400 |     127 |
| Saturday  | 4103 |   43000 |     776 |
...
```
    ...
    ##   1112432   1305761   1363766   2210217   1243562   1161556    634962   9032257
...
|:----------|--------:|-------:|---------:|--------:|
| Sunday    | 7270.80 |   2500 | 21287.84 | 3400.00 |
| Monday    | 5881.80 |   2500 |  9924.30 | 5095.56 |
| Tuesday   | 5682.36 |   2800 | 10054.24 | 4537.00 |
| Wednesday | 7979.12 |   2500 | 27816.72 | 5776.00 |
| Thursday  | 5117.54 |   2250 | 10457.84 | 4880.00 |
| Friday    | 5505.01 |   2220 | 11855.18 | 4212.00 |
| Saturday  | 5039.38 |   2500 |  8408.85 | 3862.50 |
...
![](Lifestyle_files/figure-gfm/unnamed-chunk-4-3.png)<!-- -->
...
![](Lifestyle_files/figure-gfm/unnamed-chunk-4-4.png)<!-- -->
...
![](Lifestyle_files/figure-gfm/unnamed-chunk-4-5.png)<!-- -->
...
![](Lifestyle_files/figure-gfm/unnamed-chunk-4-6.png)<!-- -->
...
![](Lifestyle_files/figure-gfm/unnamed-chunk-4-7.png)<!-- -->
...
![](Lifestyle_files/figure-gfm/unnamed-chunk-4-8.png)<!-- -->
...
```
    ...
    ## RMSE        7.842053e+03
    ## Rsquared    7.399077e-03
    ## MAE         3.398401e+03
    ## RMSESD      4.267602e+03
    ## RsquaredSD  7.999740e-03
    ## MAESD       5.148892e+02
...
```
    ...
    ## intercept   1.000000e+00
    ## RMSE        7.825606e+03
    ## Rsquared    7.008849e-03
    ## MAE         3.415689e+03
    ## RMSESD      4.322158e+03
    ## RsquaredSD  9.072860e-03
    ## MAESD       5.745479e+02
...
| RMSE       |        7842.053 |        7825.606 |
| Rsquared   |           0.007 |           0.007 |
| MAE        |        3398.401 |        3415.689 |
| RMSESD     |        4267.602 |        4322.158 |
| RsquaredSD |           0.008 |           0.009 |
| MAESD      |         514.889 |         574.548 |
...
```
    ...
    ## RMSE          7.842053e+03    7.825606e+03
    ## Rsquared      7.399077e-03    7.008849e-03
    ## MAE           3.398401e+03    3.415689e+03
    ## RMSESD        4.267602e+03    4.322158e+03
    ## RsquaredSD    7.999740e-03    9.072860e-03
    ## MAESD         5.148892e+02    5.745479e+02
...
```
    ...
    ## Summary of sample sizes: 1178, 1178, 1177, 1178, 1177, 1177, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  RMSE      Rsquared     MAE     
    ##    1    8264.459  0.006743047  3414.530
    ##    2    8311.202  0.009391838  3509.621
    ##    3    8348.296  0.008463722  3542.260
    ##    4    8403.340  0.007288268  3582.708
    ##    5    8459.153  0.006303945  3630.005
    ##    6    8506.660  0.007015447  3655.621
    ##    7    8540.589  0.006600642  3673.040
    ##    8    8601.387  0.006494477  3704.507
    ##    9    8629.522  0.005476508  3704.740
    ##   10    8669.130  0.006379524  3729.565
    ## 
...
```
    ...
    ## Summary of sample sizes: 1326, 1324, 1325, 1324, 1325, 1324, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   interaction.depth  n.trees  RMSE      Rsquared    MAE     
    ##   1                   50      7896.673  0.01233706  3443.214
    ##   1                  100      7968.075  0.01443615  3463.460
    ##   1                  150      8037.347  0.01435575  3490.587
    ##   2                   50      7983.504  0.01552010  3461.842
    ##   2                  100      8107.300  0.01463777  3537.220
    ##   2                  150      8189.686  0.01492800  3585.922
    ##   3                   50      7986.074  0.01955775  3477.971
    ##   3                  100      8133.461  0.01805906  3566.433
    ##   3                  150      8240.298  0.01661545  3636.161
    ## 
...
```
    ...
    ## RMSE       9090.155       9116.396            9095.172           9211.016
